  ...
  setup() {
    ...
    const Bebidas = ref({
      tipos: [
        ...
        { nome: "Guaraná Litro", quantidade: 0, preco: 7.0 },
        { nome: "Cajuina Litro", quantidade: 0, preco: 7.0 },
        { nome: "Coca 600ml", quantidade: 0, preco: 6.0 },
        { nome: "Coca Lata", quantidade: 0, preco: 4.5 },
        { nome: "Coca Zero Lata", quantidade: 0, preco: 4.5 },
        { nome: "Guaraná Lata", quantidade: 0, preco: 4.0 },
        { nome: "Laranja Lata", quantidade: 0, preco: 4.0 },
        { nome: "Uva Lata", quantidade: 0, preco: 4.0 },
        { nome: "São Geraldo Lata", quantidade: 0, preco: 4.0 },
        ...
        { nome: "Cerveja Heineken", quantidade: 0, preco: 8.0 },
        { nome: "Cerveja Budweiser", quantidade: 0, preco: 7.0 },
      ],
    })
